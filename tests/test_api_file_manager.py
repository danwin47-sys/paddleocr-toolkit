...
from paddleocr_toolkit.api.file_manager import router, UPLOAD_DIR, OUTPUT_DIR
...
def mock_dirs(monkeypatch):
    ...
    with tempfile.TemporaryDirectory() as tmp_uploads:
        with tempfile.TemporaryDirectory() as tmp_outputs:
            ...
            monkeypatch.setattr("paddleocr_toolkit.api.file_manager.UPLOAD_DIR", p_uploads)
            monkeypatch.setattr("paddleocr_toolkit.api.file_manager.OUTPUT_DIR", p_outputs)
