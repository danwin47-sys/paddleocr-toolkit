...
class TestModeProcessorInit:
    ...
    def test_basic_init(self, tmp_path):
        ...
        tool = Mock()
        args = argparse.Namespace(mode="basic", no_progress=False)
    ...
    def test_init_with_no_progress(self, tmp_path):
        ...
        tool = Mock()
        args = argparse.Namespace(mode="structure", no_progress=True)
...
class TestProcessMethod:
    ...
    def test_process_formula_mode(self, tmp_path):
        ...
        args = argparse.Namespace(mode="formula", latex_output=None, no_progress=False)
    ...
    def test_process_vl_mode(self, tmp_path):
        ...
        tool = Mock()
        tool.process_structured.return_value = {"pages_processed": 1, "json_files": []}
